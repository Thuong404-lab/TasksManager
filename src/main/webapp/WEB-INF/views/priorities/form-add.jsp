        ...
        <div class="container">
            <div class="form-box">
                <div class="d-flex justify-content-between align-items-start mb-4">
                    <div>
                        <h2 class="fw-bold mb-2">Thêm priority</h2>
                        <p class="text-secondary mb-0" style="font-size:18px;">Nhập thông tin mức ưu tiên</p>
                    </div>
                ...
                <form action="<%= request.getContextPath()%>/priorities" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="priorityName" value="<c:out value='${oldPriorityName}'/>" minlength="2" maxlength="50" required>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-semibold">Mã màu</label>
                        <input type="text" class="form-control" name="colorCode" value="<c:out value='${oldColorCode}'/>" pattern="#[0-9A-Fa-f]{6}" maxlength="7" required>
                    </div>

                    <div class="d-flex justify-content-end gap-3 mt-3">
                        <a href="<%= request.getContextPath()%>/priorities" class="btn btn-outline-secondary btn-rounded">Hủy</a>
                        <button type="submit" class="btn btn-primary btn-rounded">Lưu priority</button>
                    </div>
                </form>
            </div>
        </div>
