            ...
            <div class="task-modal-box">
                ...
                <form action="<%= request.getContextPath()%>/tasks" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="taskName" name="name" value="<c:out value='${task.taskName}'/>" maxlength="200" placeholder="Nhập tên công việc" required>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select class="form-select" id="priority" name="priority" required>
                                ...
                                <option value="${p.id}" ${p.id == task.priority.id ? 'selected' : ''}>${p.priorityName}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
