            ...
            <div class="form-box">
                ...
                <form action="<%= request.getContextPath()%>/priorities" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="priorityName" value="${oldPriorityName}" placeholder="Nhập tên mức ưu tiên" required>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-semibold">Mã màu</label>
                        <input type="text" class="form-control" name="colorCode" value="${oldColorCode}" placeholder="Ví dụ: #dc3545" required>
                    </div>
